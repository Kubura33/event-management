    ...
    <footer class="bg-gray-800">
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold text-white">Eventry</span>
                    </div>
                    <p class="mt-4 text-base text-gray-300">
                        Discover and join amazing events or create your own. Eventry makes it easy to connect with people who share your interests.
                    </p>
            ...
            <div class="mt-12 border-t border-gray-700 pt-8">
                <p class="text-base text-gray-400 xl:text-center">&copy; 2023 Eventry, Inc. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>
